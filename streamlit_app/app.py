...
2. Long-term contracts improve customer retention.

3. Electronic check users show elevated churn behaviour.

4. Revenue loss is concentrated among high-value customers.
"""
)